...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89F283ecC3629792b6D9670bb632e3988986403f;
...
contract Payment_Inu is Context, IERC20, Ownable {
    ...
    string private _name = "Payment Inu";
    string private _symbol = "Payment Inu";
    uint8 private _decimals = 10;
    uint256 public _rewardFee = 200; /// 200 = 20% 
    uint256 public _developmentFee = 10;  // 10 = 1% 
    uint256 public _liquidityFee = 50; // 50 = 5% 
    uint256 private _previousTaxFee = _rewardFee;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    address private _developmentWalletAddress = 0x89F283ecC3629792b6D9670bb632e3988986403f;
    ...
    uint256 public _maxTxAmount = 80000 * 10**18;
